                ...
                <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div class="flex items-center lg:order-2">
                        <button data-tooltip-target="tooltip-dark" type="button" class="inline-flex items-center p-2 mr-1 text-sm font-medium text-gray-500 rounded-lg dark:text-gray-400 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns={props.headerdropdownsettings.dark.xmlns}>
                                <use xlink:href={props.headerdropdownsettings.dark.id}></use>
                            </svg>
                        </button>
                        ...
                        <button data-tooltip-target="tooltip-statistics" type="button" class="hidden items-center p-2 text-sm font-medium text-gray-500 rounded-lg lg:inline-flex dark:text-gray-400 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns={props.headerdropdownsettings.analytics.xmlns}>
                                <use xlink:href={props.headerdropdownsettings.analytics.id}></use>
                            </svg>
                        </button>
                            ...
                            <ul class="py-1 font-light text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                                <li>
                                    <a href={props.headersubinfo.likes.url} class="flex items-center py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                        <svg class="mr-2 w-5 h-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns={props.headersubinfo.likes.xmlns}>
                                            <use xlink:href={props.headersubinfo.likes.id}></use>
                                ...
                                <li>
                                    <a href={props.headersubinfo.collections.url} class="flex items-center py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                        <svg class="mr-2 w-5 h-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns={props.headersubinfo.collections.xmlns}>
                                            <use xlink:href={props.headersubinfo.collections.id}></use>
                                ...
                                <li>
                                    ...
                                    <span class="flex items-center">
                                        <svg class="mr-2 w-5 h-5 text-primary-600 dark:text-primary-500" fill="currentColor" viewBox="0 0 20 20" xmlns={props.headersubinfo.version.xmlns}>
                                            <use xlink:href={props.headersubinfo.version.id}></use>
                                        </svg> {props.headersubinfo.version.label}
                                    </span>
                                        <svg class="w-5 h-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns={props.headersubinfo.version.subxmlns}>
                                            <use xlink:href={props.headersubinfo.version.subid}></use>
                                        </svg>
                                    </a>
                                </li>
                        ...
                        <button data-collapse-toggle="mobile-menu-2" type="button" class="inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
                            ...
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns={props.headersubinfo.openmenu.svgfxmlns}>
                                <use xlink:href={props.headersubinfo.openmenu.svgfid}></use>
                            </svg>
                            <svg class="hidden w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns={props.headersubinfo.openmenu.svgsxmlns}>
                                <use xlink:href={props.headersubinfo.openmenu.svgsid}></use>
                            </svg>
                        </button>
                    </div>
